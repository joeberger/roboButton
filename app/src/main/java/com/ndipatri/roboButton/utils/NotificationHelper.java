...
public class NotificationHelper {
    ...
    public void sendNotification(String buttonId, String buttonName, ButtonState buttonState) {
        ...
        PendingIntent togglePendingIntent = PendingIntent.getService(context, notifId, serviceIntent, PendingIntent.FLAG_CANCEL_CURRENT);

        Intent activityIntent = new Intent(context, MainActivity.class);
        PendingIntent launchPendingIntent = PendingIntent.getActivity(context, notifId, activityIntent, PendingIntent.FLAG_CANCEL_CURRENT);
