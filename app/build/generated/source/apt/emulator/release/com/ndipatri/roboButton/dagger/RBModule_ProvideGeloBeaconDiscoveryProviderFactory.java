...
public final class RBModule_ProvideGeloBeaconDiscoveryProviderFactory implements Factory<RegionDiscoveryProvider> {
  private final RBModule module;

  public RBModule_ProvideGeloBeaconDiscoveryProviderFactory(RBModule module) {  
    assert module != null;
    this.module = module;
  }
  ...
  public static Factory<RegionDiscoveryProvider> create(RBModule module) {  
    return new RBModule_ProvideGeloBeaconDiscoveryProviderFactory(module);
  }
}
