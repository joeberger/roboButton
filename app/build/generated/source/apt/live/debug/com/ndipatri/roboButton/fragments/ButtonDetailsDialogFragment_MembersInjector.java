...
public final class ButtonDetailsDialogFragment_MembersInjector implements MembersInjector<ButtonDetailsDialogFragment> {
  ...
  public ButtonDetailsDialogFragment_MembersInjector(MembersInjector<DialogFragment> supertypeInjector, Provider<ButtonProvider> buttonProvider, Provider<RegionProvider> regionProvider) {  
  ...
  public static MembersInjector<ButtonDetailsDialogFragment> create(MembersInjector<DialogFragment> supertypeInjector, Provider<ButtonProvider> buttonProvider, Provider<RegionProvider> regionProvider) {  
      return new ButtonDetailsDialogFragment_MembersInjector(supertypeInjector, buttonProvider, regionProvider);
  }
}
