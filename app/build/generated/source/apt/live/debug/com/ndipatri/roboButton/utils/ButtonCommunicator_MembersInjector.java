...
public final class ButtonCommunicator_MembersInjector implements MembersInjector<ButtonCommunicator> {
  private final Provider<ButtonDiscoveryProvider> buttonDiscoveryProvider;

  public ButtonCommunicator_MembersInjector(Provider<ButtonDiscoveryProvider> buttonDiscoveryProvider) {  
  ...
  public static MembersInjector<ButtonCommunicator> create(Provider<ButtonDiscoveryProvider> buttonDiscoveryProvider) {  
      return new ButtonCommunicator_MembersInjector(buttonDiscoveryProvider);
  }
}
