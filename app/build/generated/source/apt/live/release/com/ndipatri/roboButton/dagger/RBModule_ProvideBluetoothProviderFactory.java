...
public final class RBModule_ProvideBluetoothProviderFactory implements Factory<BluetoothProvider> {
  private final RBModule module;

  public RBModule_ProvideBluetoothProviderFactory(RBModule module) {  
    assert module != null;
    this.module = module;
  }
  ...
  public static Factory<BluetoothProvider> create(RBModule module) {  
    return new RBModule_ProvideBluetoothProviderFactory(module);
  }
}
