...
public final class RBModule$$ProvideEstimoteBeaconDiscoveryProviderFactory implements Factory<RegionDiscoveryProvider> {
  private final RBModule module;

  public RBModule$$ProvideEstimoteBeaconDiscoveryProviderFactory(RBModule module) {  
    assert module != null;
    this.module = module;
  }
  ...
  public static Factory<RegionDiscoveryProvider> create(RBModule module) {  
    return new RBModule$$ProvideEstimoteBeaconDiscoveryProviderFactory(module);
  }
}
