...
public final class RBModule$$ProvideRegionProviderFactory implements Factory<RegionProvider> {
  private final RBModule module;

  public RBModule$$ProvideRegionProviderFactory(RBModule module) {  
    assert module != null;
    this.module = module;
  }
  ...
  public static Factory<RegionProvider> create(RBModule module) {  
    return new RBModule$$ProvideRegionProviderFactory(module);
  }
}
