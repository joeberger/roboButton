...
public final class RBModule$$ProvideButtonDiscoveryProviderFactory implements Factory<ButtonDiscoveryProvider> {
  private final RBModule module;

  public RBModule$$ProvideButtonDiscoveryProviderFactory(RBModule module) {  
    assert module != null;
    this.module = module;
  }
  ...
  public static Factory<ButtonDiscoveryProvider> create(RBModule module) {  
    return new RBModule$$ProvideButtonDiscoveryProviderFactory(module);
  }
}
