...
public final class ButtonProvider$$MembersInjector implements MembersInjector<ButtonProvider> {
  private final Provider<RegionProvider> regionProvider;

  public ButtonProvider$$MembersInjector(Provider<RegionProvider> regionProvider) {  
  ...
  public static MembersInjector<ButtonProvider> create(Provider<RegionProvider> regionProvider) {  
      return new ButtonProvider$$MembersInjector(regionProvider);
  }
}
