...
public final class LeDeviceListAdapter$$MembersInjector implements MembersInjector<LeDeviceListAdapter> {
  private final MembersInjector<BaseAdapter> supertypeInjector;
  private final Provider<RegionProvider> regionProvider;

  public LeDeviceListAdapter$$MembersInjector(MembersInjector<BaseAdapter> supertypeInjector, Provider<RegionProvider> regionProvider) {  
  ...
  public static MembersInjector<LeDeviceListAdapter> create(MembersInjector<BaseAdapter> supertypeInjector, Provider<RegionProvider> regionProvider) {  
      return new LeDeviceListAdapter$$MembersInjector(supertypeInjector, regionProvider);
  }
}
