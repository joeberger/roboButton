...
public final class MainControllerActivity$$MembersInjector implements MembersInjector<MainControllerActivity> {
  private final MembersInjector<Activity> supertypeInjector;
  private final Provider<BluetoothProvider> bluetoothProvider;

  public MainControllerActivity$$MembersInjector(MembersInjector<Activity> supertypeInjector, Provider<BluetoothProvider> bluetoothProvider) {  
  ...
  public static MembersInjector<MainControllerActivity> create(MembersInjector<Activity> supertypeInjector, Provider<BluetoothProvider> bluetoothProvider) {  
      return new MainControllerActivity$$MembersInjector(supertypeInjector, bluetoothProvider);
  }
}
